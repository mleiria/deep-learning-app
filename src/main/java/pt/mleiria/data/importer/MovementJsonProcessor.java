...
public class MovementJsonProcessor implements GenericJsonProcessor {

    private static final Logger logger = LoggerFactory.getLogger(MovementJsonProcessor.class);
